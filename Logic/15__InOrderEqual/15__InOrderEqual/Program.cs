...
namespace _15__InOrderEqual
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine(InOrderEqual(2, 5, 11, false)); // → true
            Console.WriteLine(InOrderEqual(5, 7, 6, false)); // → false
            Console.WriteLine(InOrderEqual(5, 5, 7, true)); // → true
            Console.ReadLine();
        }
